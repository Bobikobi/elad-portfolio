...
2. **Neutral over-exposure on a local peak** - Earth's clouds, Venus's disc. A different
   ...
   > **CORRECTED 2026-09-14** - see [P4-brief.md](P4-brief.md), "STEP 1 RESULT".
   ...
   > the output, after `highlightRolloff` had already pushed those pixels toward white. Confirmed by the
   > repeatability control: a second capture of the same build reads exactly zero against the first.
