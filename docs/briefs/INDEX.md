...
| [SUN-2](SUN-2-brief.md) - granulation, limb darkening, live limb, deeper lanes ([verify](SUN-2-verify.md)) | 2026-08-08 | PARTIAL - C3 and C4 pass, C1 reaches 1.38x of a 2.5x target and C2 arrives as 2% of a 32% darkening. Measured cause: the disc sits at 205-230 of 255 in every radial bin, so ACES compresses the detail away and desaturates the gold. Needs an owner ruling on exposure or bloom, both load-bearing elsewhere | 43e6e97 (lane `feat/sun-2`) |
