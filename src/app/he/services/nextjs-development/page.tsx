...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://www.eladsaadon.dev/he/services/nextjs-development',
    languages: {
...
const schemas = [
  {
    ...
    url: 'https://www.eladsaadon.dev/he/services/nextjs-development',
    provider: {
      '@type': 'Person',
      name: 'Elad Saadon',
...
export default function NextJsDevelopmentPage() {
  const breadcrumbs = [
    ...
    { label: 'פיתוח Next.js', href: '/he/services/nextjs-development' },
  ];
