 ...
 * focused. Server-rendered (real crawlable content), sits in the reading column
 * (inline-start: right in RTL, left in LTR) so the planet fills the opposite side.
 * NO backdrop-filter (expensive over the canvas) — a solid rgba glass per the spec.
 */
